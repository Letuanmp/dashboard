    ...
    <div class="main-content flex-1 bg-gray-100 mt-12 md:mt-2 pb-24 md:pb-5">
        ...
        <div class="flex flex-wrap">
                ...
                <div class="bg-gradient-to-b from-red-900 to-indigo-100 border-b-4 border-red-500 rounded-lg shadow-xl p-5">
                    <div class="flex flex-row items-center">
                        ...
                        <div class="flex-1 text-right md:text-center">
                            <h5 class="font-bold uppercase text-white-600" style="color: white">Số sản
                                phẩm</h5>
                            <h3 class="font-bold text-3xl" style="color: white"><?= $totalRecords ?> sản phẩm</h3>
                        </div>
                    </div>
                </div>
                <!--/Metric Card-->
            ...
            <div class="w-full p-6 flex flex-row-reverse">
                ...
                <!--                </button>-->
                <button class=" ml-8 bg-red-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full">
                    <a
