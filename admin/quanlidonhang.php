                ...
                <li class="flex-1 md:flex-none md:mr-3">
                    <div class="inline-block relative">
                        ...
                        <div class="overflow-auto absolute right-0 invisible z-30 p-3 mt-3 text-white bg-gray-800 dropdownlist"
                            ...
                            <a class="block p-2 text-sm text-white no-underline hover:bg-red-800 hover:no-underline"
                               href="dangnhap.php"
                               style="width: 120px;"><i
    ...
    <div class="bg-gray-800 shadow-xl h-16 fixed bottom-0 mt-12 md:relative md:h-screen z-10 w-full md:w-48">
        ...
        <div class="md:mt-12 md:w-50 md:fixed md:left-0 md:top-0 content-center md:content-start text-left justify-between">
            <ul class="list-reset flex flex-row md:flex-col py-0 md:py-3 px-1 md:px-2 text-center md:text-left">
                ...
                <li class="mr-3 flex-1">
                    <a class="block py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-gray-800 hover:border-red-700"
                ...
                <li class="mr-3 flex-1">
                    <a class="block py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-gray-800 hover:border-red-500"
    ...
    <div class="main-content flex-1 bg-gray-100 mt-12 md:mt-2 pb-24 md:pb-5">
        ...
        <div class="flex flex-wrap">
            <div class="w-full p-6">
                <!--Metric Card-->
                <div class="bg-gradient-to-b from-red-800 to-red-100 border-b-4 border-red-500 rounded-lg shadow-xl p-5">
                    <div class="flex flex-row items-center">
                        ...
                        <div class="flex-1 text-right md:text-center">
                            <h5 class="font-bold uppercase text-gray-600" style="color: white">Số đơn
                                hàng</h5>
                            <h3 class="font-bold text-3xl" style="color: white"><?= $totalRecords ?> đơn</h3>
                        </div>
                    </div>
                </div>
                    ...
                    <form action="quanlidonhang.php?action=search" method="POST">
                        <div class="flex ">
                            ...
                            <button type="submit" value="Tìm"
                                    class=" rounded px-4 mr-2 text-white bg-red-500 border-l  ">
                                Tìm
                            </button>
                        </div>
                    </form>
